...
function init() {
    ...
    // Cờ đỏ / Banner trên bảng - HAI DÒNG TRANG TRỌNG (Font siêu nhỏ)
    ...
    // Vẽ 2 dòng
    bCtx.fillText("SỐNG, CHIẾN ĐẤU, LAO ĐỘNG VÀ HỌC TẬP", 1024, 125);
    bCtx.fillText("THEO GƯƠNG BÁC HỒ VĨ ĐẠI", 1024, 195);
